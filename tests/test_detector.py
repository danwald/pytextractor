...
class TestDetector(object):
    ...
    @pytest.mark.parametrize('image', [
        str(TEST_IMAGES / '52.png'),
        str(TEST_IMAGES / '53.png'),
        str(TEST_IMAGES / '56.png'),
    ])
    ...
    @pytest.mark.parametrize('image,expected_number', [
        (str(TEST_IMAGES / '53.png'), 53),
        (str(TEST_IMAGES / '56.png'), 56),
        (str(TEST_IMAGES / '57.png'), 57),
    ])
